...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.progressBar)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.outputToFile)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.outputFilenameVal)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.showMap)
        self.showAllNeighbors = QtWidgets.QCheckBox(self.mainTab)
        self.showAllNeighbors.setEnabled(True)
        self.showAllNeighbors.setObjectName("showAllNeighbors")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.showAllNeighbors)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.scrollToLastCmdHistory)
        ...
        self.gridLayout.addWidget(self.cmdHistory, 11, 0, 8, 1)
        ...
        self.gridLayout.addWidget(self.resetBtn, 18, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.tableWidget, 0, 1, 11, 6)
        ...
        self.gridLayout.addWidget(self.outputCmd, 11, 3, 5, 4)
        ...
        self.gridLayout.addWidget(self.quitBtn, 18, 3, 1, 4)
        self.stopTestBtn = QtWidgets.QPushButton(self.mainTab)
        self.stopTestBtn.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stopTestBtn.sizePolicy().hasHeightForWidth())
        self.stopTestBtn.setSizePolicy(sizePolicy)
        self.stopTestBtn.setMinimumSize(QtCore.QSize(0, 25))
        self.stopTestBtn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.stopTestBtn.setObjectName("stopTestBtn")
        self.gridLayout.addWidget(self.stopTestBtn, 16, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.startTestBtn, 16, 3, 1, 2)
        ...
        self.pktSizeVal.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pktSizeVal.setFont(font)
        self.pktSizeVal.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        ...
        self.pktResDial.setProperty("value", 13)
        ...
        self.exportIncData = QtWidgets.QCheckBox(self.consoleTab)
        self.exportIncData.setChecked(True)
        self.exportIncData.setObjectName("exportIncData")
        self.gridLayout_3.addWidget(self.exportIncData, 1, 3, 1, 1)
        self.exportIncFinalStats = QtWidgets.QCheckBox(self.consoleTab)
        self.exportIncFinalStats.setObjectName("exportIncFinalStats")
        self.gridLayout_3.addWidget(self.exportIncFinalStats, 2, 3, 1, 1)
        self.exportIncTestInfo = QtWidgets.QCheckBox(self.consoleTab)
        self.exportIncTestInfo.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.exportIncTestInfo.setChecked(True)
        self.exportIncTestInfo.setObjectName("exportIncTestInfo")
        self.gridLayout_3.addWidget(self.exportIncTestInfo, 0, 3, 1, 1)
        self.lowerText = QtWidgets.QTextEdit(self.consoleTab)
        self.lowerText.setReadOnly(True)
        self.lowerText.setObjectName("lowerText")
        self.gridLayout_3.addWidget(self.lowerText, 8, 0, 6, 4)
        ...
        self.gridLayout_3.addWidget(self.upperText, 0, 0, 8, 3)
        self.line_2 = QtWidgets.QFrame(self.consoleTab)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout_3.addWidget(self.line_2, 6, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.scrollToLastOutput, 7, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.exportDataBtn, 4, 3, 1, 1)
        self.exportIncMapList = QtWidgets.QCheckBox(self.consoleTab)
        self.exportIncMapList.setObjectName("exportIncMapList")
        self.gridLayout_3.addWidget(self.exportIncMapList, 3, 3, 1, 1)
        self.stopTestBtn2 = QtWidgets.QPushButton(self.consoleTab)
        self.stopTestBtn2.setEnabled(False)
        self.stopTestBtn2.setObjectName("stopTestBtn2")
        self.gridLayout_3.addWidget(self.stopTestBtn2, 5, 3, 1, 1)
        self.gridLayout_3.setColumnStretch(0, 1)
        self.gridLayout_3.setRowStretch(0, 1)
        self.gridLayout_5.addLayout(self.gridLayout_3, 0, 1, 1, 1)
        self.tabWidget.addTab(self.consoleTab, "")
        self.rootTab = QtWidgets.QWidget()
        self.rootTab.setAutoFillBackground(False)
        self.rootTab.setObjectName("rootTab")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.rootTab)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.rootOutputText = QtWidgets.QTextBrowser(self.rootTab)
        self.rootOutputText.setObjectName("rootOutputText")
        self.verticalLayout.addWidget(self.rootOutputText)
        self.gridLayout_6.addLayout(self.verticalLayout, 5, 0, 1, 1)
        self.gridLayout_7 = QtWidgets.QGridLayout()
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.line_3 = QtWidgets.QFrame(self.rootTab)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_7.addWidget(self.line_3, 3, 0, 1, 12)
        self.pibSetVal = QtWidgets.QLineEdit(self.rootTab)
        self.pibSetVal.setEnabled(False)
        self.pibSetVal.setObjectName("pibSetVal")
        self.gridLayout_7.addWidget(self.pibSetVal, 10, 1, 1, 3)
        self.line_5 = QtWidgets.QFrame(self.rootTab)
        self.line_5.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.gridLayout_7.addWidget(self.line_5, 4, 10, 8, 1)
        self.label_12 = QtWidgets.QLabel(self.rootTab)
        self.label_12.setEnabled(False)
        self.label_12.setAlignment(QtCore.Qt.AlignCenter)
        self.label_12.setObjectName("label_12")
        self.gridLayout_7.addWidget(self.label_12, 10, 0, 1, 1)
        self.rootAddrVal = QtWidgets.QLineEdit(self.rootTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rootAddrVal.sizePolicy().hasHeightForWidth())
        self.rootAddrVal.setSizePolicy(sizePolicy)
        self.rootAddrVal.setObjectName("rootAddrVal")
        self.gridLayout_7.addWidget(self.rootAddrVal, 0, 3, 1, 5)
        self.runCmdVal = QtWidgets.QLineEdit(self.rootTab)
        self.runCmdVal.setObjectName("runCmdVal")
        self.gridLayout_7.addWidget(self.runCmdVal, 1, 3, 1, 5)
        self.lidSearchBtn = QtWidgets.QPushButton(self.rootTab)
        self.lidSearchBtn.setObjectName("lidSearchBtn")
        self.gridLayout_7.addWidget(self.lidSearchBtn, 11, 5, 1, 5)
        self.testConnectionBtn = QtWidgets.QPushButton(self.rootTab)
        self.testConnectionBtn.setObjectName("testConnectionBtn")
        self.gridLayout_7.addWidget(self.testConnectionBtn, 0, 8, 1, 4)
        self.runCmdBtn = QtWidgets.QPushButton(self.rootTab)
        self.runCmdBtn.setObjectName("runCmdBtn")
        self.gridLayout_7.addWidget(self.runCmdBtn, 1, 8, 1, 4)
        self.label_14 = QtWidgets.QLabel(self.rootTab)
        self.label_14.setEnabled(False)
        self.label_14.setAlignment(QtCore.Qt.AlignCenter)
        self.label_14.setObjectName("label_14")
        self.gridLayout_7.addWidget(self.label_14, 10, 5, 1, 1)
        self.pibLayerCombo = QtWidgets.QComboBox(self.rootTab)
        self.pibLayerCombo.setObjectName("pibLayerCombo")
        self.pibLayerCombo.addItem("")
        self.pibLayerCombo.addItem("")
        self.pibLayerCombo.addItem("")
        self.pibLayerCombo.addItem("")
        self.gridLayout_7.addWidget(self.pibLayerCombo, 8, 1, 1, 3)
        self.pibSearchBtn = QtWidgets.QPushButton(self.rootTab)
        self.pibSearchBtn.setObjectName("pibSearchBtn")
        self.gridLayout_7.addWidget(self.pibSearchBtn, 11, 0, 1, 4)
        self.rootAppendLogsCheckBox = QtWidgets.QCheckBox(self.rootTab)
        self.rootAppendLogsCheckBox.setChecked(True)
        self.rootAppendLogsCheckBox.setObjectName("rootAppendLogsCheckBox")
        self.gridLayout_7.addWidget(self.rootAppendLogsCheckBox, 11, 11, 1, 1)
        self.pibSearchVal = QtWidgets.QLineEdit(self.rootTab)
        self.pibSearchVal.setObjectName("pibSearchVal")
        self.gridLayout_7.addWidget(self.pibSearchVal, 9, 1, 1, 3)
        self.LidGetSetCombo = QtWidgets.QComboBox(self.rootTab)
        self.LidGetSetCombo.setEnabled(False)
        self.LidGetSetCombo.setObjectName("LidGetSetCombo")
        self.LidGetSetCombo.addItem("")
        self.LidGetSetCombo.addItem("")
        self.gridLayout_7.addWidget(self.LidGetSetCombo, 7, 6, 1, 4)
        self.label_11 = QtWidgets.QLabel(self.rootTab)
        self.label_11.setAlignment(QtCore.Qt.AlignCenter)
        self.label_11.setObjectName("label_11")
        self.gridLayout_7.addWidget(self.label_11, 9, 5, 1, 1)
        self.line_4 = QtWidgets.QFrame(self.rootTab)
        self.line_4.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.gridLayout_7.addWidget(self.line_4, 4, 4, 8, 1)
        self.rootExportPib = QtWidgets.QPushButton(self.rootTab)
        self.rootExportPib.setObjectName("rootExportPib")
        self.gridLayout_7.addWidget(self.rootExportPib, 9, 11, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.rootTab)
        self.label_8.setAlignment(QtCore.Qt.AlignCenter)
        self.label_8.setObjectName("label_8")
        self.gridLayout_7.addWidget(self.label_8, 9, 0, 1, 1)
        self.pibGetSetCombo = QtWidgets.QComboBox(self.rootTab)
        self.pibGetSetCombo.setEnabled(False)
        self.pibGetSetCombo.setObjectName("pibGetSetCombo")
        self.pibGetSetCombo.addItem("")
        self.pibGetSetCombo.addItem("")
        self.gridLayout_7.addWidget(self.pibGetSetCombo, 7, 1, 1, 3)
        self.label_13 = QtWidgets.QLabel(self.rootTab)
        self.label_13.setAlignment(QtCore.Qt.AlignCenter)
        self.label_13.setObjectName("label_13")
        self.gridLayout_7.addWidget(self.label_13, 8, 0, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.rootTab)
        font = QtGui.QFont()
        ...
        self.gridLayout_7.addWidget(self.label_10, 4, 0, 1, 4)
        self.label_9 = QtWidgets.QLabel(self.rootTab)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_7.addWidget(self.label_9, 4, 5, 1, 5)
        self.rootClearBtn = QtWidgets.QPushButton(self.rootTab)
        self.rootClearBtn.setObjectName("rootClearBtn")
        self.gridLayout_7.addWidget(self.rootClearBtn, 10, 11, 1, 1)
        self.label_27 = QtWidgets.QLabel(self.rootTab)
        self.label_27.setAlignment(QtCore.Qt.AlignCenter)
        self.label_27.setObjectName("label_27")
        self.gridLayout_7.addWidget(self.label_27, 7, 5, 1, 1)
        self.label_26 = QtWidgets.QLabel(self.rootTab)
        self.label_26.setAlignment(QtCore.Qt.AlignCenter)
        self.label_26.setObjectName("label_26")
        self.gridLayout_7.addWidget(self.label_26, 7, 0, 1, 1)
        self.lidSearchVal = QtWidgets.QLineEdit(self.rootTab)
        self.lidSearchVal.setObjectName("lidSearchVal")
        self.gridLayout_7.addWidget(self.lidSearchVal, 9, 6, 1, 4)
        self.pibSetVal_2 = QtWidgets.QLineEdit(self.rootTab)
        self.pibSetVal_2.setEnabled(False)
        self.pibSetVal_2.setObjectName("pibSetVal_2")
        self.gridLayout_7.addWidget(self.pibSetVal_2, 10, 6, 1, 4)
        self.runCmdLab = QtWidgets.QLabel(self.rootTab)
        self.runCmdLab.setAlignment(QtCore.Qt.AlignCenter)
        self.runCmdLab.setObjectName("runCmdLab")
        self.gridLayout_7.addWidget(self.runCmdLab, 1, 0, 1, 2)
        self.rootCmdcomboBox = QtWidgets.QComboBox(self.rootTab)
        self.rootCmdcomboBox.setObjectName("rootCmdcomboBox")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.rootCmdcomboBox.addItem("")
        self.gridLayout_7.addWidget(self.rootCmdcomboBox, 1, 2, 1, 1)
        self.rootAddrLab = QtWidgets.QLabel(self.rootTab)
        self.rootAddrLab.setAlignment(QtCore.Qt.AlignCenter)
        self.rootAddrLab.setObjectName("rootAddrLab")
        self.gridLayout_7.addWidget(self.rootAddrLab, 0, 0, 1, 2)
        self.gridLayout_6.addLayout(self.gridLayout_7, 2, 0, 1, 1)
        self.tabWidget.addTab(self.rootTab, "")
    ...
    def retranslateUi(self, MainObj):
        ...
        self.showAllNeighbors.setText(_translate("MainObj", "ALL neighbors"))
        ...
        self.stopTestBtn.setToolTip(_translate("MainObj", "Start the test with the command shown in the above window"))
        self.stopTestBtn.setText(_translate("MainObj", "Stop Test"))
        ...
        self.pktResVal.setText(_translate("MainObj", "156"))
        ...
        self.exportIncData.setText(_translate("MainObj", "Include all data"))
        self.exportIncFinalStats.setText(_translate("MainObj", "Include final statistics"))
        self.exportIncTestInfo.setToolTip(_translate("MainObj", "Include the map list and the final statistics in the exported data"))
        self.exportIncTestInfo.setText(_translate("MainObj", "Include Test Info"))
        ...
        self.exportIncMapList.setText(_translate("MainObj", "Include mapping List"))
        self.stopTestBtn2.setText(_translate("MainObj", "Stop Test"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.consoleTab), _translate("MainObj", "Output"))
        self.label_12.setText(_translate("MainObj", "Set pib value"))
        self.rootAddrVal.setText(_translate("MainObj", "dddd::d1"))
        self.runCmdVal.setText(_translate("MainObj", "modversion.sh"))
        self.lidSearchBtn.setText(_translate("MainObj", "Search LID"))
        self.testConnectionBtn.setText(_translate("MainObj", "Test Connection"))
        self.runCmdBtn.setText(_translate("MainObj", "Run Command"))
        self.label_14.setText(_translate("MainObj", "Set LID value"))
        self.pibLayerCombo.setItemText(0, _translate("MainObj", "All"))
        self.pibLayerCombo.setItemText(1, _translate("MainObj", "rf_phy"))
        self.pibLayerCombo.setItemText(2, _translate("MainObj", "rf_mac"))
        self.pibLayerCombo.setItemText(3, _translate("MainObj", "mas"))
        self.pibSearchBtn.setText(_translate("MainObj", "Search PIB"))
        self.rootAppendLogsCheckBox.setText(_translate("MainObj", "Append logs"))
        self.pibSearchVal.setText(_translate("MainObj", "pan"))
        self.LidGetSetCombo.setItemText(0, _translate("MainObj", "GET"))
        self.LidGetSetCombo.setItemText(1, _translate("MainObj", "SET"))
        self.label_11.setText(_translate("MainObj", "Filter String"))
        self.rootExportPib.setText(_translate("MainObj", "Export PIBs"))
        self.label_8.setText(_translate("MainObj", "Filter String"))
        self.pibGetSetCombo.setItemText(0, _translate("MainObj", "GET"))
        self.pibGetSetCombo.setItemText(1, _translate("MainObj", "SET"))
        self.label_13.setText(_translate("MainObj", "Layer"))
        self.label_10.setText(_translate("MainObj", "PIB"))
        self.label_9.setText(_translate("MainObj", "LID"))
        self.rootClearBtn.setText(_translate("MainObj", "Clear log"))
        self.label_27.setText(_translate("MainObj", "Get/Set"))
        self.label_26.setText(_translate("MainObj", "Get/Set"))
        self.lidSearchVal.setText(_translate("MainObj", "pwr"))
        self.runCmdLab.setText(_translate("MainObj", "Run command"))
        self.rootCmdcomboBox.setItemText(0, _translate("MainObj", "self"))
        self.rootCmdcomboBox.setItemText(1, _translate("MainObj", "ngcstatus"))
        self.rootCmdcomboBox.setItemText(2, _translate("MainObj", "modversion"))
        self.rootCmdcomboBox.setItemText(3, _translate("MainObj", "DODAG table"))
        self.rootCmdcomboBox.setItemText(4, _translate("MainObj", "neighbor-dump t0"))
        self.rootCmdcomboBox.setItemText(5, _translate("MainObj", "neighbor-dump t7"))
        self.rootCmdcomboBox.setItemText(6, _translate("MainObj", "neighbor-dump t1"))
        self.rootAddrLab.setText(_translate("MainObj", "Root IPv6 Address "))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rootTab), _translate("MainObj", "Root"))
