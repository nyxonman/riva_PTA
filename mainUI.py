...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.comboBox = QtWidgets.QComboBox(self.rootTab)
    ...
    def retranslateUi(self, MainObj):
        ...
        self.comboBox.setItemText(0, _translate("MainObj", "self"))
        self.comboBox.setItemText(1, _translate("MainObj", "ngcstatus"))
        self.comboBox.setItemText(2, _translate("MainObj", "modversion"))
        self.comboBox.setItemText(3, _translate("MainObj", "neighbor-dump t0"))
        self.comboBox.setItemText(4, _translate("MainObj", "neighbor-dump t7"))
        self.comboBox.setItemText(5, _translate("MainObj", "neighbor-dump t1"))
