...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.startTestBtn_2 = QtWidgets.QPushButton(self.mainTab)
        self.startTestBtn_2.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.startTestBtn_2.sizePolicy().hasHeightForWidth())
        self.startTestBtn_2.setSizePolicy(sizePolicy)
        self.startTestBtn_2.setMinimumSize(QtCore.QSize(0, 25))
        self.startTestBtn_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.startTestBtn_2.setObjectName("startTestBtn_2")
        self.gridLayout.addWidget(self.startTestBtn_2, 16, 5, 1, 2)
    ...
    def retranslateUi(self, MainObj):
        ...
        self.startTestBtn_2.setToolTip(_translate("MainObj", "Start the test with the command shown in the above window"))
        self.startTestBtn_2.setText(_translate("MainObj", "Stop Test"))
