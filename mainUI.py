...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.showAllNeighbors)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.scrollToLastCmdHistory)
        self.camVersionLab = QtWidgets.QLabel(self.mainTab)
        self.camVersionLab.setObjectName("camVersionLab")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.camVersionLab)
        self.camVersionDropBox = QtWidgets.QComboBox(self.mainTab)
        self.camVersionDropBox.setObjectName("camVersionDropBox")
        self.camVersionDropBox.addItem("")
        self.camVersionDropBox.addItem("")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.camVersionDropBox)
        ...
        self.gridLayout_7.addWidget(self.rootAddrLab, 0, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.runCmdLab, 1, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.label_11, 8, 5, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.rootExportPib, 10, 11, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.rootClearBtn, 11, 11, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.lidSearchVal, 8, 6, 1, 4)
        ...
        self.gridLayout_7.addWidget(self.label_14, 9, 5, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pibSetVal_2, 9, 6, 1, 4)
    ...
    def retranslateUi(self, MainObj):
        ...
        self.camVersionLab.setToolTip(_translate("MainObj", "Number of ROOTs for test. This reflects to number of columns in the right side table"))
        self.camVersionLab.setText(_translate("MainObj", "CAM Version"))
        self.camVersionDropBox.setCurrentText(_translate("MainObj", "CAM3"))
        self.camVersionDropBox.setItemText(0, _translate("MainObj", "CAM3"))
        self.camVersionDropBox.setItemText(1, _translate("MainObj", "CAM1"))
