...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.pibLayerCombo.addItem("")
        self.pibLayerCombo.addItem("")
        self.gridLayout_7.addWidget(self.pibLayerCombo, 6, 2, 1, 1)
        self.pibTypeCombo = QtWidgets.QComboBox(self.rootTab)
        self.pibTypeCombo.setObjectName("pibTypeCombo")
        self.pibTypeCombo.addItem("")
        self.pibTypeCombo.addItem("")
        self.pibTypeCombo.addItem("")
        self.pibTypeCombo.addItem("")
        self.pibTypeCombo.addItem("")
        self.pibTypeCombo.addItem("")
        self.gridLayout_7.addWidget(self.pibTypeCombo, 6, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_10, 4, 4, 1, 1)
        self.label_7 = QtWidgets.QLabel(self.rootTab)
        self.label_7.setAlignment(QtCore.Qt.AlignCenter)
        self.label_7.setObjectName("label_7")
        self.gridLayout_7.addWidget(self.label_7, 4, 1, 1, 1)
        self.pibIdentifierCombo = QtWidgets.QComboBox(self.rootTab)
        self.pibIdentifierCombo.setObjectName("pibIdentifierCombo")
        self.pibIdentifierCombo.addItem("")
        self.pibIdentifierCombo.addItem("")
        self.pibIdentifierCombo.addItem("")
        self.pibIdentifierCombo.addItem("")
        self.pibIdentifierCombo.addItem("")
        self.pibIdentifierCombo.addItem("")
        self.gridLayout_7.addWidget(self.pibIdentifierCombo, 6, 4, 1, 1)
        self.testConnectionBtn = QtWidgets.QPushButton(self.rootTab)
        self.testConnectionBtn.setObjectName("testConnectionBtn")
        self.gridLayout_7.addWidget(self.testConnectionBtn, 0, 5, 1, 1)
        self.getSetCombo = QtWidgets.QComboBox(self.rootTab)
        self.getSetCombo.setObjectName("getSetCombo")
        self.getSetCombo.addItem("")
        self.getSetCombo.addItem("")
        self.gridLayout_7.addWidget(self.getSetCombo, 6, 1, 1, 1)
        self.runCmdBtn = QtWidgets.QPushButton(self.rootTab)
        self.runCmdBtn.setObjectName("runCmdBtn")
        self.gridLayout_7.addWidget(self.runCmdBtn, 1, 5, 1, 1)
        self.runPibCmdBtn = QtWidgets.QPushButton(self.rootTab)
        self.runPibCmdBtn.setAutoDefault(False)
        self.runPibCmdBtn.setDefault(False)
        self.runPibCmdBtn.setFlat(False)
        self.runPibCmdBtn.setObjectName("runPibCmdBtn")
        self.gridLayout_7.addWidget(self.runPibCmdBtn, 6, 5, 1, 1)
        self.searchPibBtn = QtWidgets.QPushButton(self.rootTab)
        self.searchPibBtn.setObjectName("searchPibBtn")
        self.gridLayout_7.addWidget(self.searchPibBtn, 7, 5, 1, 1)
        self.rootAddrLab = QtWidgets.QLabel(self.rootTab)
        self.rootAddrLab.setObjectName("rootAddrLab")
        self.gridLayout_7.addWidget(self.rootAddrLab, 0, 0, 1, 1)
        self.line_3 = QtWidgets.QFrame(self.rootTab)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_7.addWidget(self.line_3, 3, 0, 1, 6)
        self.pibCmdLab = QtWidgets.QLabel(self.rootTab)
        self.pibCmdLab.setObjectName("pibCmdLab")
        self.gridLayout_7.addWidget(self.pibCmdLab, 4, 0, 4, 1)
        self.pibSetVal = QtWidgets.QLineEdit(self.rootTab)
        self.pibSetVal.setEnabled(False)
        self.pibSetVal.setObjectName("pibSetVal")
        self.gridLayout_7.addWidget(self.pibSetVal, 7, 2, 1, 3)
        self.runCmdVal = QtWidgets.QLineEdit(self.rootTab)
        self.runCmdVal.setObjectName("runCmdVal")
        self.gridLayout_7.addWidget(self.runCmdVal, 1, 1, 1, 4)
        self.rootAddrVal = QtWidgets.QLineEdit(self.rootTab)
        self.rootAddrVal.setObjectName("rootAddrVal")
        self.gridLayout_7.addWidget(self.rootAddrVal, 0, 1, 1, 4)
        self.pibSearchVal = QtWidgets.QLineEdit(self.rootTab)
        self.pibSearchVal.setObjectName("pibSearchVal")
        self.gridLayout_7.addWidget(self.pibSearchVal, 7, 1, 1, 1)
        self.runCmdLab = QtWidgets.QLabel(self.rootTab)
        self.runCmdLab.setObjectName("runCmdLab")
        self.gridLayout_7.addWidget(self.runCmdLab, 1, 0, 1, 1)
        self.rootClearBtn = QtWidgets.QPushButton(self.rootTab)
        self.rootClearBtn.setObjectName("rootClearBtn")
        self.gridLayout_7.addWidget(self.rootClearBtn, 8, 3, 1, 2)
        self.rootScrollToLast = QtWidgets.QCheckBox(self.rootTab)
        self.rootScrollToLast.setChecked(True)
        self.rootScrollToLast.setObjectName("rootScrollToLast")
        self.gridLayout_7.addWidget(self.rootScrollToLast, 8, 5, 1, 1)
    ...
    def retranslateUi(self, MainObj):
        ...
        self.pibTypeCombo.setItemText(0, _translate("MainObj", "All"))
        self.pibTypeCombo.setItemText(1, _translate("MainObj", "dynamic_config"))
        self.pibTypeCombo.setItemText(2, _translate("MainObj", "hardcoded"))
        self.pibTypeCombo.setItemText(3, _translate("MainObj", "static_config"))
        self.pibTypeCombo.setItemText(4, _translate("MainObj", "statistics"))
        self.pibTypeCombo.setItemText(5, _translate("MainObj", "status"))
        self.label_8.setText(_translate("MainObj", "Layer"))
        self.label_9.setText(_translate("MainObj", "Type"))
        self.label_10.setText(_translate("MainObj", "Identifier"))
        self.label_7.setText(_translate("MainObj", "Get/Set"))
        self.pibIdentifierCombo.setItemText(0, _translate("MainObj", "All"))
        self.pibIdentifierCombo.setItemText(1, _translate("MainObj", "dynamic_config"))
        self.pibIdentifierCombo.setItemText(2, _translate("MainObj", "hardcoded"))
        self.pibIdentifierCombo.setItemText(3, _translate("MainObj", "static_config"))
        self.pibIdentifierCombo.setItemText(4, _translate("MainObj", "statistics"))
        self.pibIdentifierCombo.setItemText(5, _translate("MainObj", "status"))
        self.testConnectionBtn.setText(_translate("MainObj", "Test Connection"))
        self.getSetCombo.setItemText(0, _translate("MainObj", "GET"))
        self.getSetCombo.setItemText(1, _translate("MainObj", "SET"))
        self.runCmdBtn.setText(_translate("MainObj", "Run"))
        self.runPibCmdBtn.setText(_translate("MainObj", "Run"))
        self.searchPibBtn.setText(_translate("MainObj", "Search"))
        self.rootAddrLab.setText(_translate("MainObj", "Root IPv6 Address "))
        self.pibCmdLab.setText(_translate("MainObj", "Pib Commands"))
        self.runCmdVal.setText(_translate("MainObj", "modversion.sh"))
        self.rootAddrVal.setText(_translate("MainObj", "dddd::1"))
        self.runCmdLab.setText(_translate("MainObj", "Run command"))
        self.rootClearBtn.setText(_translate("MainObj", "Clear log"))
        self.rootScrollToLast.setText(_translate("MainObj", "Scroll To Last"))
