...
class Ui_MainObj(object):
    def setupUi(self, MainObj):
        ...
        self.gridLayout_7.addWidget(self.line_3, 3, 0, 1, 11)
        ...
        self.gridLayout_7.addWidget(self.pibSetVal, 10, 0, 1, 4)
        ...
        self.gridLayout_7.addWidget(self.rootExportPib, 10, 10, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.rootClearBtn, 11, 10, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.testConnectionBtn, 0, 8, 1, 3)
        self.runCmdBtn = QtWidgets.QPushButton(self.rootTab)
        self.runCmdBtn.setObjectName("runCmdBtn")
        self.gridLayout_7.addWidget(self.runCmdBtn, 1, 8, 1, 3)
    ...
    def retranslateUi(self, MainObj):
        ...
        self.label_11.setText(_translate("MainObj", "Lid String"))
        self.rootExportPib.setText(_translate("MainObj", "Export Pibs"))
        self.label_8.setText(_translate("MainObj", "Pib Str"))
