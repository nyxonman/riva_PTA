...
CMD_MAC_TX_STAT   = 'pib -gln /mas/statistics/f2_txmgr |grep "DataConfirmSuccess\|DataConfirmFailure\|fskTx_ppduCnt_0\|fskRx_failCnt_0"'
CMD_MAC_TSN       = "pib -gn .rf_mac.status.sync_mgr.macTSN"
